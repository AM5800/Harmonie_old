...
//import am5800.harmonie.android.TextViewController
//import am5800.harmonie.model.Flow
//import am5800.harmonie.android.FlowManager
//import am5800.harmonie.model.FlowType
//import am5800.harmonie.android.BindableView
//import am5800.harmonie.android.ReflectionBindableController
//import android.widget.LinearLayout
//import org.joda.time.*
//import org.joda.time.format.PeriodFormatterBuilder
//
//class FlowController(parentLifetime: Lifetime,
//                     private val flowManager: FlowManager,
//                     private val contentManagers: List<ContentManagerControllerProvider>,
//                     private val controllerRegistry: ControllerStack) : ReflectionBindableController(R.layout.flow_fragment) {
...
//
//  val timeLeft: TextViewController = TextViewController(R.id.timeLeftTextView, "", Visibility.Visible, true)
//
//  private fun continueFlow(flow: Flow) {
//    val current = flow.currentItem
//    var vm = if (current == null)
//      EmptyFlowContentController()
//    else
