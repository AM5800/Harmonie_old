...
import dataProcessor.LearnGraphCreator
...
class LearnGraphCreatorTests {
  ...
  fun test1() {
    ...
    val actual = LearnGraphCreator.createGraph(counts, language, occurrences)
  ...
  private fun makeUi(word: String, vararg sentences: String): LearnGraphNode {
    return LearnGraphNode(Word(language, word), sentences.map { Sentence(language, it) })
  }
